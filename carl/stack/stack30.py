...
rami=pd.read_csv('../rami/rami.meta.train.csv',index_col=idname)
rami=rami[mask]

rami_test=pd.read_csv('../rami/rami.meta.test.csv',index_col=idname)


tian=pd.read_csv('../tian/tian_cv.csv')
tian1=pd.read_csv('../tian/predictions/et1_cv.csv')
tian2=pd.read_csv('../tian/predictions/et2_cv.csv')
tian3=pd.read_csv('../tian/predictions/rt1_cv.csv')
tian4=pd.read_csv('../tian/predictions/xgb1_cv.csv')
tian=tian[mask]
tian1=tian1[mask]
tian2=tian2[mask]
tian3=tian3[mask]
...
for name in train.columns.values :
    if train[name].value_counts().shape[0]<1000 and name not in badx:
...
#X=np.vstack([X.T,tian[labelname].values]).T
X=np.vstack([X.T,tian1[labelname].values]).T
X=np.vstack([X.T,tian2[labelname].values]).T
X=np.vstack([X.T,tian3[labelname].values]).T
X=np.vstack([X.T,tian4[labelname].values]).T

X=np.vstack([X.T,pd.read_csv('../cv/good/xgb4.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ridge1.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/xgb11.csv',index_col=idname)[labelname].values]).T

X=np.vstack([X.T,pd.read_csv('../cv/good/ex3.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ex4.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ex6.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada1.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada6.csv',index_col=idname)[labelname].values]).T

X=np.vstack([X.T,pd.read_csv('../cv/good/ada7.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada8.csv',index_col=idname)[labelname].values]).T
#X=np.vstack([X.T,pd.read_csv('../cv/good/ada9.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada10.csv',index_col=idname)[labelname].values]).T
...
X=np.vstack([X.T,pd.read_csv('../bench/ex5cv.csv',index_col=idname)['PredictedProb'].values]).T
X=np.vstack([X.T,pd.read_csv('../bench/h2ocv.csv',index_col=idname)['PredictedProb'].values]).T
X=np.vstack([X.T,pd.read_csv('../bench/2ndnbxgbcv.csv',index_col=idname)['PredictedProb'].values]).T
X=np.vstack([X.T,pd.read_csv('../bench/glm2cv.csv',index_col=idname).fillna(0.76)['PredictedProb'].values]).T


labelname='PredictedProb'
#Xt=np.vstack([Xt.T,pd.read_csv('../tian/XGB_group2_int_double_freq5.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../tian/predictions/et1_sub.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../tian/predictions/et2_sub.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../tian/predictions/rt1_sub.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../tian/predictions/xgb1_sub.csv',index_col=idname)[labelname].values]).T
...
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ex3.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ex4.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ex6.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada1.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada6.csv',index_col=idname)[labelname].values]).T

Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada7.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada8.csv',index_col=idname)[labelname].values]).T
#Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada9.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada10.csv',index_col=idname)[labelname].values]).T
...
Xt=np.vstack([Xt.T,pd.read_csv('../bench/2ndnbxgbtest.csv',index_col=idname)['PredictedProb'].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../bench/glm2.csv',index_col=idname).fillna(0.76)['PredictedProb'].values]).T

X=np.hstack([X,rami.as_matrix()])
Xt=np.hstack([Xt,rami_test.as_matrix()])
...
clf=xgb_classifier(eta=0.01,min_child_weight=2,col=0.7,subsample=0.8,depth=5,num_round=500,seed=0,gamma=0)
yp=clf.train_predict(X[:,xx],y,Xt[:,xx])
s=pd.DataFrame({idname:idx,'PredictedProb':yp})
s.to_csv('stack30.csv',index=False)
