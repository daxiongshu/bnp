...
X=np.vstack([X.T,pd.read_csv('../cv/good/ada2.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada3.csv',index_col=idname)[labelname].values]).T
X=np.vstack([X.T,pd.read_csv('../cv/good/ada4.csv',index_col=idname)[labelname].values]).T
...
X=np.vstack([X.T,pd.read_csv('../bench/x1cv_xgb.csv',index_col=idname).fillna(0.76)['PredictedProb'].values]).T
...
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada2.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada3.csv',index_col=idname)[labelname].values]).T
Xt=np.vstack([Xt.T,pd.read_csv('../cv/ada4.csv',index_col=idname)[labelname].values]).T
...
Xt=np.vstack([Xt.T,pd.read_csv('../bench/x1_xgb.csv',index_col=idname).fillna(0.76)['PredictedProb'].values]).T
...
s.to_csv('stack25.csv',index=False)
