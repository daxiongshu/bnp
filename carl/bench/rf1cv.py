...
extc = RandomForestClassifier(n_estimators=100,max_features= 50,criterion= 'entropy',min_samples_split= 4,verbose=1,n_jobs=-1,
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('rf1cv.csv',index=False)
