#https://www.kaggle.com/ouranos/bnp-paribas-cardif-claims-management/lasagne-nn/code
import numpy as np
import pandas as pd
...
trainId = train["ID"]
testId = test["ID"]
droplist=list(set(["v22","v107","v71","v31","v100","v63","v64"]+['v8','v23','v25','v31','v36','v37','v46','v51','v53','v54','v63','v73','v75','v79','v81','v82','v89','v92','v95','v105','v107','v108','v109','v110','v116','v117','v118','v119','v123','v124','v128']))
...
submission.to_csv('nn3cv/nn3cv_%s.csv'%num, index=False)
