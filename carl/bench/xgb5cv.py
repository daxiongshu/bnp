...
extc = XGBClassifier(max_depth=5,n_estimators=100,nthread=-1)#max_features= 50,criterion= 'entropy',min_samples_split= 4,
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('xgb5cv.csv',index=False)
