...
train = pd.read_csv('../input/tr.csv', usecols=['ID', 'target', 'v22'])
test = pd.read_csv('../input/va.csv', usecols=['ID', 'v22'])
...
train_score = log_loss(train[target_column], train_preds.values)
...
predictions_file = open("v1cv.csv", "w", 2048)
