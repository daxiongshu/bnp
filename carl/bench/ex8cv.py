...
X_test = test
print('Training...')
extc = ExtraTreesClassifier(n_estimators=850,max_features= 40,criterion= 'entropy',min_samples_split= 4,verbose=1,
...
pd.DataFrame({"ID": id_test, "PredictedProb": y_pred[:,1]}).to_csv('ex8cv.csv',index=False)
