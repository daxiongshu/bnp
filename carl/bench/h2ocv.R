...
train<-h2o.uploadFile("../input/tr.csv",destination_frame = "train.hex")  
test<-h2o.uploadFile("../input/va.csv",destination_frame = "test.hex")     
...
write.csv(submission,"h2ocv.csv",row.names=F)
