...
def kfold_cv(X_train, y_train,idx,k):
    ...
    for train_index, test_index in kf:
        ...
        #y_pred/=m;
        clf=XGBClassifier(max_depth=12,colsample_bytree=0.5,learning_rate=0.01,n_estimators=1200,nthread=-1)
...
#train=train[good]
good0='v113, v56, v72, v71, v12, v14, v24, v129, v21, v66, v47, v10, v30, v62, v110, v38, v50, v31, v79'
good0=[i.strip() for i in good0.split(',')]
good=[i for i in good if i not in good0]
...
for name in train.columns.values :
    if  name in newf:# and name not in good:
