...
X=np.hstack((train[good].as_matrix(),train1.as_matrix()))
Xt=np.hstack((test[good].as_matrix(),test1.as_matrix()))
...
clf=AdaBoostClassifier(
            n_estimators = 20,
            learning_rate = 0.2,
            base_estimator = ExtraTreesClassifier(n_estimators=100,max_features= 30,criterion= 'entropy',min_samples_split= 4,
